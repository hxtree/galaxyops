...
class LambdaLayerStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const nestJsAppLayer = new aws_lambda_1.LayerVersion(this, 'NestJsAppLayer', {
            layerVersionName: `arn:aws:lambda:${awsAccountRegion}:${awsAccountId}:layer:NestJsAppLayer`,
            compatibleArchitectures: [aws_lambda_1.Architecture.X86_64, aws_lambda_1.Architecture.ARM_64],
