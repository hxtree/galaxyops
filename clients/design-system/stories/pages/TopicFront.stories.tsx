...
import { Article, AppBar, Button, Typography, Alert, PageFooter, Link, faArrowRight, FontAwesomeIcon, HeroBanner, AlertSeverity } from '../../src/main';
...
export const Default = () => (
    <>
      ...
      <HeroBanner heading={'Et malesuada fames ac turpis.'} lead={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vehicula metus quis sagittis malesuada. Nulla facilisi. Duis feugiat tellus eu justo hendrerit, nec congue odio congue.'} image={''}>
      </HeroBanner>
