  ...
  return (
    <>
      <Alert severity={AlertSeverity.INFO}>
        Explore a wider range of icons in the{' '}
        <a
        ...
        , offering an extensive collection of fonts that are not yet integrated
        but can easily be added to the design system.
      </Alert>
      <div className="d-flex flex-wrap">
        {icons.map(({ icon, name }, index) => (
          <div className="mx-4 mb-5" key={index}>
            <Paper
              elevation="6"
              className="d-flex flex-column justify-content-center align-items-center rounded position-relative"
            ...
            >
              ...
              />
              <div
                className="text-muted position-absolute start-50 bottom-0 translate-middle"
                style={{ fontSize: '0.6rem', marginBottom: '1px' }}
              >
                {name}
              </div>
            </Paper>
