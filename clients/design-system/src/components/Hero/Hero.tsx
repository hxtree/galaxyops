...
export const Hero = (props: HeroProps) => {
  ...
  return (
    ...
    <div className={classNames.join(' ')}>
          <div className="backgroundFacet" style={{backgroundImage: `url(${image})`}}></div>
          <div className='px-sm-1 px-md-3 px-lg-5 pt-sm-1 pt-md-3 pt-lg-5 pb-0'>
            <div className="row">
              ...
              <div className="d-none d-lg-block col-lg-5 position-relative">
                {imageRight && <img src={imageRight} alt="" className="focal-image img-fluid position-absolute bottom-0 start-50 translate-middle-x" />}
              </div>
            </div>
          </div>
        </div>
