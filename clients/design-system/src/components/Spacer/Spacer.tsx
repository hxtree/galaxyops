...
const Spacer: React.FC<SpacerProps> = ({ top = 0, right = 0, bottom = 0, left = 0, children }) => {
  ...
  const hasSpacing = normalizedTop > 0 || normalizedRight > 0 || normalizedBottom > 0 || normalizedLeft > 0;
