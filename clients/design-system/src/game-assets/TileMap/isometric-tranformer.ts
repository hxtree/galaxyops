import { Coordinate3D, Coordinate2D } from './Coordinate.type';
 ...
 */
export function toScreenCoordinate(tile: Coordinate3D): Coordinate2D {
  const scaledX =
  ...
  return {
    x: scaledX + CAMERA_OFFSET_X,
    y: scaledY + CAMERA_OFFSET_Y,
  };
}
