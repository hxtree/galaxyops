...
export namespace WeaponSkill {
  ...
  export const Parry: WeaponType = {
    name: Weapon.PARRY,
    description: 'Ward off incoming attack with a countermove.',
    effect: [],
  };

  export const Slash: WeaponType = {
    name: Weapon.SLASH,
  ...
  export const Strike: WeaponType = {
    name: Weapon.STRIKE,
  ...
  export const Cleave: WeaponType = {
    name: Weapon.CLEAVE,
