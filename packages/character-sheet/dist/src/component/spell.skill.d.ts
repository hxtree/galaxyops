 ...
 */
export declare enum SpellSkillList {
    'Gravity' = 0,
    'Shock' = 1,
    'Quake' = 2,
    'Landslide' = 3,
...
export declare abstract class SpellSkill implements BaseSkill {
    abstract name: string;
    abstract description: string;
    menuSlot: MenuSlot.First;
    category: SkillCategory.CLASS;
}
export declare class Gravity extends SpellSkill {
    name: 'Gravity';
...
export declare class Shock extends SpellSkill {
    name: 'Shock';
...
export declare class Quake extends SpellSkill {
    name: 'Quake';
...
export declare class Landslide extends SpellSkill {
    name: 'Landslide';
...
export declare class Blizzard extends SpellSkill {
    name: 'Blizzard';
...
export declare class Fireball extends SpellSkill {
    name: 'Fireball';
...
export declare class Inferno extends SpellSkill {
    name: 'Inferno';
...
export declare class Twister extends SpellSkill {
    name: 'Twister';
...
export declare class Gust extends SpellSkill {
    name: 'Gust';
...
export declare class Gale extends SpellSkill {
    name: 'Gale';
...
export declare class Cyclone extends SpellSkill {
    name: 'Cyclone';
...
export declare class Tsunami extends SpellSkill {
    name: 'Tsunami';
...
export declare class Aqua extends SpellSkill {
    name: 'Aqua';
...
export declare class Heal extends SpellSkill {
    name: 'Heal';
...
export declare class Revive extends SpellSkill {
    name: 'Revive';
...
export declare class Cure extends SpellSkill {
    name: 'Cure';
...
export declare class Barrier extends SpellSkill {
    name: 'Barrier';
...
export declare class Boom extends SpellSkill {
    name: 'Boom';
...
export declare class Reflect extends SpellSkill {
    name: 'Reflect';
...
export declare class Flare extends SpellSkill {
    name: 'Flare';
...
export declare class Meteor extends SpellSkill {
    name: 'Meteor';
...
export declare class Telepathy extends SpellSkill {
    name: 'Telepathy';
...
export declare class Light extends SpellSkill {
    name: 'Light';
...
export declare class Desolate extends SpellSkill {
    name: 'Desolate';
...
export declare class Darkness extends SpellSkill {
    name: 'Darkness';
...
export declare class Stop extends SpellSkill {
    name: 'Stop';
...
export declare class Slow extends SpellSkill {
    name: 'Slow';
...
export declare class Haste extends SpellSkill {
    name: 'Haste';
...
export declare class Chill extends SpellSkill {
    name: 'Chill';
    description: '';
    targets: 1;
}
export declare class Charm extends SpellSkill {
    name: 'Charm';
    description: '';
    targets: 1;
}
export declare class Frost extends SpellSkill {
    name: 'Frost';
    description: '';
    targets: 1;
}
export declare class Absorb extends SpellSkill {
    name: 'Frost';
    description: '';
    targets: 1;
}
export declare class Leech extends SpellSkill {
    name: 'Leech';
    description: '';
    targets: 1;
}
export declare class Drain extends SpellSkill {
    name: 'Drain';
    description: '';
    targets: 1;
}
