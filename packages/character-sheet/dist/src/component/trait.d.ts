 ...
 * COLD WEAKNESS 2x
 */
export declare type WeaknessTrait = {
    tag: EffectTag;
 ...
 */
export declare type ResistanceTrait = {
    tag: EffectTag;
 ...
 */
export declare type BonusTrait = {
    tag: EffectTag;
 ...
 * COLD ABSORB
 */
export declare type AbsorbTrait = {
    tag: EffectTag;
    quantity: number;
 ...
 * SLEEP IMMUNE
 */
export declare type ImmuneTrait = {
    tag: EffectTag;
 ...
 * ELECTRIC HEAL 20%
 */
export declare type HealTrait = {
    tag: EffectTag;
    modifier: Effect.HEAL;
    percent: number;
};
export declare type Trait = WeaknessTrait | ResistanceTrait | BonusTrait | AbsorbTrait | ImmuneTrait | HealTrait;
