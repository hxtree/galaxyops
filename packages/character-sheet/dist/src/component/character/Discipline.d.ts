import { Boast, Cheer, Dismiss, Hope, Inspire, Rage, Scan, Support } from '../skill/ClassSkill';
...
import { Aqua, Blizzard, Charm, Chill, Darkness, Desolate, Drain, Flare, Frost, Gust, Haste, Heal, Landslide, Leech, Light, Quake, Slow, Stop, Tsunami } from '../skill/SpellSkill';
