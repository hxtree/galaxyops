(self.webpackChunk_cats_cradle_design_system =
  ...
  [236],
  {
    ...
    '../../common/temp/node_modules/.pnpm/shallowequal@1.1.0/node_modules/shallowequal/index.js':
      module => {
    ...
    '../../common/temp/node_modules/.pnpm/styled-components@5.3.11_react-dom@18.2.0_react-is@18.2.0_react@18.2.0/node_modules/styled-components/dist/styled-components.browser.esm.js':
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          ZP: () => styled_components_browser_esm,
        });
              ...
              if (
                ...
                switch (g) {
                  ...
                  case 59:
                    if (
                      1 <
                      (t = (f = (0 < r ? f.replace(N, '') : f).trim()).length)
                    )
                      switch (
                        (0 === u &&
                          ((q = f.charCodeAt(0)),
        ...
        var emotion_is_prop_valid_esm = __webpack_require__(
          ...
          process = __webpack_require__(
            '../../common/temp/node_modules/.pnpm/process@0.11.10/node_modules/process/browser.js',
          );
        function y() {
          return (y =
            Object.assign ||
        ...
        var ce = react.createContext(),
          le = (ce.Consumer, react.createContext()),
        ...
        function me(e) {
          ...
          return (
            ...
            react.createElement(
              ce.Provider,
              { value: u },
              react.createElement(le.Provider, { value: l }, e.children),
            )
          );
        }
        var ye = (function () {
                ...
                for (var C in N)
                  '$' !== C[0] &&
                    ...
                    ('forwardedAs' === C
                      ? (A.as = N[C])
                      : (l
                          ? l(C, emotion_is_prop_valid_esm.Z, b)
                          : !_ || (0, emotion_is_prop_valid_esm.Z)(C)) &&
                        (A[C] = N[C]));
                return (
                  t.style &&
                    v.style !== t.style &&
                  ...
                  (A.className = Array.prototype
                    ...
                    .join(' ')),
                  (A.ref = S),
                  (0, react.createElement)(b, A)
                );
              })(A, e, t, I);
            };
          return (
            (P.displayName = p),
            ((A = react.forwardRef(P)).attrs = g),
            (A.componentStyle = C),
            (A.displayName = p),
            ...
            i &&
              hoist_non_react_statics_cjs_default()(A, e, {
                attrs: !0,
                componentStyle: !0,
                displayName: !0,
        ...
        var qe = function (e) {
          return (function e(t, r, o) {
            if ((void 0 === o && (o = w), !(0, react_is.isValidElementType)(r)))
              return D(1, String(r));
            var s = function () {
        ...
        !(function () {
          function e() {
            ...
            (this._emitSheetCSS = function () {
              ...
              (this.getStyleElement = function () {
                ...
                return (
                  o && (n.nonce = o),
                  [react.createElement('style', y({}, n, { key: 'sc-0-0' }))]
                );
              }),
              (this.seal = function () {
                e.sealed = !0;
          ...
          (t.collectStyles = function (e) {
            return this.sealed
              ? D(2)
              : react.createElement(me, { sheet: this.instance }, e);
          }),
            (t.interleaveWithNodeStream = function (e) {
              return D(3);
            });
        })();
        const styled_components_browser_esm = qe;
      },
  },
]);
